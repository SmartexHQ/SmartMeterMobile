...
abstract class AuthLocalStorageDataSource {
  ...
  Future<bool> seenLockFeature();

  Future<void> setSeenLockFeature();
}
...
class AuthLocalStorageDataSourceImp implements AuthLocalStorageDataSource {
  ...
  final String _seenLockFeature = 'SeenLockFeaturyyzue7917199ueu';
  ...
  @override
  Future<bool> seenLockFeature() async {
    final String? hasSeen = await storage.read(key: _seenLockFeature);
  ...
  @override
  Future<void> setSeenLockFeature() async {
    await storage.write(key: _seenLockFeature, value: true.toString());
  }
}
